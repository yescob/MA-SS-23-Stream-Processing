...
```bash
http aggregator:8081/weather-stations/data/1
```
...
```bash
http aggregator:8081/weather-stations/meta-data
```
...
```bash
http cf143d359acc:8081/weather-stations/data/1
```
...
Location: http://72064bb97be9:8081/weather-stations/data/2
```

You can have _httpie_ automatically follow the redirect by passing the `--follow` option:

```bash
http --follow aggregator:8081/weather-stations/data/2
```
